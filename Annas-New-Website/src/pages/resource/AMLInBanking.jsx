    ...
    <>
      <div className="flex min-h-[60vh] flex-col gap-8 px-8 py-20">
        ...
        <Typography variant="paragraph">
          ...
          money laundering and other financial crimes. Money laundering is the
          process of disguising the proceeds of criminal activity as legitimate
          funds, which can then be used to finance further criminal activity or
          to evade taxes. AML regulations require financial institutions to
          develop and implement risk-based policies, procedures, and controls to
          detect, prevent, and report money laundering activities. The main
          components of an AML program include: Customer Due Diligence (CDD):
          ...
          with them. This includes collecting and verifying customer
          ...
          customers. Suspicious Activity Monitoring and Reporting: Financial
          ...
          relevant authorities. AML Training and Awareness: Financial
          ...
          requirements. Record Keeping: Financial institutions must maintain
          accurate records of customer identification information, transactions,
          and AML program activities. AML Risk Assessment: Financial
          ...
          financial institution’s compliance and risk management framework. AML
          regulations help to prevent money laundering, terrorism financing,
